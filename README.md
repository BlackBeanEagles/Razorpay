...
2. Complete **one** real purchase through the storefront — pay with Razorpay's published test-mode card at real Checkout, and let it confirm. This puts one genuine order into `guardrail/ledger.json`.
